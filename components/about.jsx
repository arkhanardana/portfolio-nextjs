...
export default function About() {
	return (
		<div className="container mx-auto scroll-mt-0" id="about">
			<div className="flex mx-10 md:mx-16 my-10 justify-between items-center">
			...
			<AnimateParagraph
				...
				delay={0.5}
				className="text-[0.9rem] leading-relaxed sm:text-base md:leading-relaxed md:text-xl lg:text-[1.30rem] mx-10 md:mx-16"
			/>
		</div>
	);
}
